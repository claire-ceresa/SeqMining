...
class Ui_DB_Search(object):
    def setupUi(self, DB_Search):
        ...
        self.checkbox_project = QtWidgets.QCheckBox(self.groupbox_gen)
        self.checkbox_project.setObjectName("checkbox_project")
        self.layout_project.addWidget(self.checkbox_project)
        self.combobox_project = QtWidgets.QComboBox(self.groupbox_gen)
        ...
        self.verticalLayout.addLayout(self.layout_project)
        ...
        self.layout_date.addItem(spacerItem2)

...
class Ui_DB_Search(object):
    def setupUi(self, DB_Search):
        ...
        self.verticalLayout_6.addWidget(self.groupbox_gen)
        ...
        self.checkbox_project = QtWidgets.QCheckBox(self.groupBox)
        self.checkbox_project.setObjectName("checkbox_project")
        self.layout_project.addWidget(self.checkbox_project)
        self.combobox_project = QtWidgets.QComboBox(self.groupBox)
        self.combobox_project.setEnabled(False)
        self.combobox_project.setObjectName("combobox_project")
        self.layout_project.addWidget(self.combobox_project)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.layout_project.addItem(spacerItem1)
        self.verticalLayout_5.addLayout(self.layout_project)
        self.layout_function = QtWidgets.QHBoxLayout()
        self.layout_function.setObjectName("layout_function")
        self.checkbox_function = QtWidgets.QCheckBox(self.groupBox)
        self.checkbox_function.setObjectName("checkbox_function")
        self.layout_function.addWidget(self.checkbox_function)
        self.combobox_function = QtWidgets.QComboBox(self.groupBox)
        self.combobox_function.setEnabled(False)
        self.combobox_function.setObjectName("combobox_function")
        self.layout_function.addWidget(self.combobox_function)
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.layout_function.addItem(spacerItem2)
        self.verticalLayout_5.addLayout(self.layout_function)
        self.layout_function_2 = QtWidgets.QHBoxLayout()
        self.layout_function_2.setObjectName("layout_function_2")
        self.checkbox_subfunction = QtWidgets.QCheckBox(self.groupBox)
        self.checkbox_subfunction.setObjectName("checkbox_subfunction")
        self.layout_function_2.addWidget(self.checkbox_subfunction)
        self.combobox_subfunction = QtWidgets.QComboBox(self.groupBox)
        self.combobox_subfunction.setEnabled(False)
        self.combobox_subfunction.setObjectName("combobox_subfunction")
        self.layout_function_2.addWidget(self.combobox_subfunction)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.layout_function_2.addItem(spacerItem3)
        self.verticalLayout_5.addLayout(self.layout_function_2)
        ...
        self.layout_date.addWidget(self.checkbox_date)
        ...
        self.combobox_date.addItem("")
        self.combobox_date.addItem("")
        self.layout_date.addWidget(self.combobox_date)
        ...
        self.layout_date.addWidget(self.edit_date_1)
        ...
        self.layout_date.addWidget(self.label_date_et)
        ...
        self.layout_date.addWidget(self.edit_date_2)
        spacerItem4 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.layout_date.addItem(spacerItem4)
        ...
        self.verticalLayout_6.addWidget(self.groupbox_detail)
        ...
        self.verticalLayout_6.addWidget(self.groupbox_org)
        ...
        self.verticalLayout_6.addWidget(self.groupbox_ref)
        self.button_search = QtWidgets.QPushButton(self.centralwidget)
        self.button_search.setObjectName("button_search")
        self.verticalLayout_6.addWidget(self.button_search)
        DB_Search.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(DB_Search)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 525, 26))
        self.menubar.setObjectName("menubar")
        self.menu_gestion = QtWidgets.QMenu(self.menubar)
        self.menu_gestion.setObjectName("menu_gestion")
        self.menu_extraire = QtWidgets.QMenu(self.menubar)
        self.menu_extraire.setObjectName("menu_extraire")
        self.menu_importer = QtWidgets.QMenu(self.menubar)
        self.menu_importer.setObjectName("menu_importer")
        DB_Search.setMenuBar(self.menubar)
        self.action_project = QtWidgets.QAction(DB_Search)
        self.action_project.setObjectName("action_project")
        self.action_non_traitees = QtWidgets.QAction(DB_Search)
        self.action_non_traitees.setObjectName("action_non_traitees")
        self.action_completes = QtWidgets.QAction(DB_Search)
        self.action_completes.setObjectName("action_completes")
        self.menu_gestion.addAction(self.action_project)
        self.menu_extraire.addAction(self.action_non_traitees)
        self.menu_importer.addAction(self.action_completes)
        self.menubar.addAction(self.menu_gestion.menuAction())
        self.menubar.addAction(self.menu_extraire.menuAction())
        self.menubar.addAction(self.menu_importer.menuAction())
        ...
        self.checkbox_project.toggled['bool'].connect(self.combobox_project.setEnabled)
        ...
        self.action_project.triggered.connect(DB_Search.action_project_triggered)
        self.action_non_traitees.triggered.connect(DB_Search.action_non_traitees_triggered)
        self.action_completes.triggered.connect(DB_Search.action_completes_triggered)
        self.checkbox_function.toggled['bool'].connect(self.combobox_function.setEnabled)
        self.checkbox_subfunction.toggled['bool'].connect(self.combobox_subfunction.setEnabled)
        self.combobox_function.currentTextChanged['QString'].connect(DB_Search.combobox_function_changed)
    ...
    def retranslateUi(self, DB_Search):
        ...
        self.groupBox.setTitle(_translate("DB_Search", "Coraliotech"))
        self.checkbox_project.setText(_translate("DB_Search", "Projet"))
        self.checkbox_function.setText(_translate("DB_Search", "Fonction"))
        self.checkbox_subfunction.setText(_translate("DB_Search", "Sous-fonction"))
        ...
        self.menu_gestion.setTitle(_translate("DB_Search", "Gestion"))
        self.menu_extraire.setTitle(_translate("DB_Search", "Extraire"))
        self.menu_importer.setTitle(_translate("DB_Search", "Importer"))
        self.action_project.setText(_translate("DB_Search", "Projets"))
        self.action_non_traitees.setText(_translate("DB_Search", "Données non traitées"))
        self.action_completes.setText(_translate("DB_Search", "Données complétées"))

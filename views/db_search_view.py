...
class Ui_DB_Search(object):
    def setupUi(self, DB_Search):
        ...
        self.edit_download_1 = QtWidgets.QDateTimeEdit(self.groupbox_gen)
        ...
        self.edit_download_2 = QtWidgets.QDateTimeEdit(self.groupbox_gen)
        ...
        self.edit_date_1 = QtWidgets.QDateTimeEdit(self.groupbox_detail)

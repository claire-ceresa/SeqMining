...
class Ui_NCBI_Result(object):
    def setupUi(self, NCBI_Result):
        ...
        self.verticalLayout.addLayout(self.layout_request)
        ...
        self.verticalLayout.addLayout(self.layout_help)
        self.label_result = QtWidgets.QLabel(self.groupbox_products)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_error = QtWidgets.QLabel(self.groupbox_products)
        ...
        self.label_selectall = QtWidgets.QLabel(self.groupbox_products)
        font = QtGui.QFont()
        font.setUnderline(True)
        ...
        self.label_deselectall = QtWidgets.QLabel(self.groupbox_products)
        font = QtGui.QFont()
        font.setUnderline(True)
        ...
        self.label_nb = QtWidgets.QLabel(self.groupbox_products)
        self.label_nb.setObjectName("label_nb")
        self.layout_select.addWidget(self.label_nb)
        self.combobox_nb = QtWidgets.QComboBox(self.groupbox_products)
        ...
        self.label_previous = QtWidgets.QLabel(self.groupbox_products)
        font = QtGui.QFont()
        font.setUnderline(True)
        self.label_previous.setFont(font)
        self.label_previous.setStyleSheet("color: rgb(11, 0, 168);")
        self.label_previous.setObjectName("label_previous")
        self.horizontalLayout.addWidget(self.label_previous)
        self.label_page = QtWidgets.QLabel(self.groupbox_products)
        self.label_page.setObjectName("label_page")
        self.horizontalLayout.addWidget(self.label_page)
        self.combobox_page = QtWidgets.QComboBox(self.groupbox_products)
        self.combobox_page.setMaximumSize(QtCore.QSize(50, 22))
        self.combobox_page.setObjectName("combobox_page")
        self.horizontalLayout.addWidget(self.combobox_page)
        self.label_on = QtWidgets.QLabel(self.groupbox_products)
        self.label_on.setObjectName("label_on")
        self.horizontalLayout.addWidget(self.label_on)
        self.label_next = QtWidgets.QLabel(self.groupbox_products)
        font = QtGui.QFont()
        font.setUnderline(True)
        self.label_next.setFont(font)
        self.label_next.setStyleSheet("color: rgb(11, 0, 168);")
        self.label_next.setObjectName("label_next")
        self.horizontalLayout.addWidget(self.label_next)
        self.verticalLayout.addLayout(self.horizontalLayout)
        self.button_extract_all = QtWidgets.QPushButton(self.groupbox_products)
        self.button_extract_all.setObjectName("button_extract_all")
        self.verticalLayout.addWidget(self.button_extract_all)
        self.button_extract_select = QtWidgets.QPushButton(self.groupbox_products)
        self.button_extract_select.setObjectName("button_extract_select")
        self.verticalLayout.addWidget(self.button_extract_select)
        self.verticalLayout_3.addWidget(self.groupbox_products)
        ...
        self.button_extract_all.clicked.connect(NCBI_Result.button_extract_all_clicked)
    ...
    def retranslateUi(self, NCBI_Result):
        ...
        self.label_previous.setText(_translate("NCBI_Result", "< Prec"))
        self.label_page.setText(_translate("NCBI_Result", "Page"))
        self.label_on.setText(_translate("NCBI_Result", "sur"))
        self.label_next.setText(_translate("NCBI_Result", "Suiv >"))
        self.button_extract_all.setText(_translate("NCBI_Result", "Tout extraire vers un fichier Excel"))
